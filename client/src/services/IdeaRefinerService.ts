    ...
    try {
      ...
      if (error.response?.data) {
        throw {
          ...
          message: error.response.data.message || 'An error occurred while processing your idea.',
      ...
      throw {
        error: 'Network error',
        message: error.message || 'Unable to connect to the server. Please check your connection and try again.'
      } as IdeaRefinementError;
    }
  }
