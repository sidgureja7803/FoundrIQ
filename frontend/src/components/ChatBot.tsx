...
const PREDEFINED_ANSWERS: Record<string, string> = {
  "what is startup buddy": "Startup Buddy is an AI-powered platform that helps founders analyze and validate startup ideas using real-time market research, cultural alignment insights, competitive benchmarking, and strategy generation.",
...
const ChatBot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      text: "Hi there! 👋 I'm your Startup Buddy assistant. Ask me anything about our platform, how it works, or startup validation!", 
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
    ...
    <>
      ...
      >
        ...
        <div className="bg-blue-600 text-white p-4 flex items-center gap-2">
          <Bot size={20} />
          <h3 className="font-medium">Startup Buddy Assistant</h3>
